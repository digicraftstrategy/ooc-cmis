<div>
                ...
                @forelse ($paginatedRegions as $region)
                    <tr>
                        ...
                        <td class="px-6 py-4 text-sm font-medium whitespace-nowrap">
                            {{ $region->created_at ? $region->created_at->format('M d, Y') : '—' }}
                        </td>
                        <td class="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                            <div class="flex items-center space-x-2">
                                <x-blue-button-sm wire:click="openViewModal({{ $region->id }})">
        ...
        <div class="fixed inset-0 z-40 flex items-center justify-center p-4 bg-black bg-opacity-50"
            ...
            <div class="w-full max-w-md bg-white rounded-lg shadow-xl">
                ...
                <div class="px-4 py-3 bg-gray-50 sm:px-6 sm:flex sm:flex-row-reverse">
                    <button type="button" wire:click="deleteRegion"
    ...
    <!-- Include Components -->
    @livewire('admin.regions.create-region')
    @livewire('admin.regions.edit-region')
    @livewire('admin.regions.view-region')
