<div class="px-6 py-4">
    <div class="flex items-center justify-between mb-6">
        <div>
            <h3 class="text-lg font-medium text-gray-900">Create Classification Rating</h3>
            <p class="mt-1 text-sm text-gray-600">Add a new film classification rating</p>
        </div>
    ...
    <form wire:submit="save" class="space-y-6">
        <div class="bg-white space-y-6">
            ...
            <div>
                ...
                <div class="mt-1">
                    <input type="file" wire:model="icon_path"
                           class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100">
                    @error('icon_path') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                </div>
                @if ($icon_path)
                    <div class="mt-2">
                        <p class="text-sm text-gray-600">Preview:</p>
                        <img src="{{ $icon_path->temporaryUrl() }}" class="mt-1 w-16 h-16 object-contain border rounded">
                    </div>
                @endif
            </div>
