        ...
        <div class="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-2xl shadow-lg overflow-hidden">
            <div class="px-6 py-6">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div>
                        <h1 class="text-2xl font-bold text-white">Edit Video Game</h1>
                        <p class="text-blue-100 opacity-90 text-sm">
                            Update an existing video game so officers can classify and rate.
                        </p>
                    </div>
                ...
                <nav class="mt-4 text-xs text-blue-100">
                    <ol class="flex items-center gap-2">
                        <li><a href="{{ route('admin.classifications.video-games') }}" class="hover:underline">Video Games</a></li>
                        <li>/</li>
                        <li class="text-white font-medium">Edit</li>
                        <li>/</li>
                        <li class="text-blue-100 truncate max-w-[180px]">
                            {{ $game->video_game_title ?: 'Untitled' }}
                        </li>
                    </ol>
                </nav>
            </div>
