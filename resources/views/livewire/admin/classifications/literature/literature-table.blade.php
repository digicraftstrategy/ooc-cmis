        ...
        <div class="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-xl shadow-lg overflow-hidden">
            <div class="px-6 py-6">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div>
                        <h1 class="text-xl md:text-2xl font-bold text-white mb-1">Manage Literature/Books</h1>
                        <p class="text-blue-100 opacity-90 text-sm">Manage all Literature/Books in the system</p>
                    </div>
