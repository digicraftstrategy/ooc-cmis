    ...
    <header class="px-4 sm:px-6 lg:px-8 py-6">
        <div class="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-2xl shadow-lg overflow-hidden">
            <div class="px-6 py-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    <h1 class="text-2xl font-bold text-white">Edit Literature</h1>
            ...
            <div class="lg:col-span-8 space-y-6">
                ...
                <section class="bg-white rounded-xl border shadow-sm overflow-hidden">
                    <div class="px-5 py-4 border-b">
                        ...
                        <p class="text-xs text-slate-500">Update the cover image if needed.</p>
                    </div>
                    <div class="p-5 space-y-3">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            @if($literature->cover_art_path)
                                <div>
                                    <p class="text-xs font-medium text-slate-600 mb-1">Current cover</p>
                            ...
                            @if($cover_art)
                                <div>
                                    <p class="text-xs font-medium text-slate-600 mb-1">New preview</p>
                        ...
                        <p class="text-[11px] text-slate-500">Supported formats: JPEG, PNG (Max: 2MB).</p>
                    </div>
                </section>
                <!-- Bottom Actions -->
