            ...
            <div class="p-6 md:p-8">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    ...
                    <div class="flex flex-wrap gap-3">
                        <x-blue-button-link href="{{ route('admin.classifications.classified-items', $premisesOwner->uuid) }}" wire:navigate
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <div class="flex items-center gap-2">
                                            ...
                                            @if($premisesOwner->website)
                                                <a href="{{ $premisesOwner->website }}" target="_blank" class="text-blue-600 hover:text-blue-800 font-medium transition-colors duration-200">
                                                    {{ $premisesOwner->website }}
                                                </a>
                                            @else
                                                <span class="text-gray-400 font-medium">No website Address Provided</span>
                                            @endif
                                        </div>
                                    </div>
                                </div>
