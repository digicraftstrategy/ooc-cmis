            ...
            <div class="px-6 py-8 md:px-8 md:py-10">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                    ...
                    <button wire:click="openCreateModal"
                        class="px-6 py-3 bg-white text-blue-600 hover:bg-blue-50 border-transparent shadow-lg font-medium rounded-lg transition-all duration-200 transform hover:-translate-y-0.5 flex items-center">
