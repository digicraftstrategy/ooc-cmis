<div>
    <div class="mb-4 flex flex-wrap items-center gap-4">
        ...
        <div class="flex">
            <x-blue-button-link href="{{ route('system.roles.create') }}" wire:navigate
        ...
        <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-blue-50">
                <tr>
                    ...
                    <th scope="col"
                        class="px-6 py-6 text-xs font-medium tracking-wider text-right text-blue-700 uppercase">
                        Actions
                    </th>
                </tr>
            </thead>
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                            <div class="relative text-left" x-data="{ open: false }">
                                <x-blue-button-sm x-on:click="open = !open">
                                    <x-icons.three-dots />
                                </x-blue-button-sm>
